...
# 2. Ghép nối đường dẫn động cho thư mục dữ liệu và thư mục lưu model
DATA_DIR = os.path.join(BASE_DIR, "data", "laptop", "splits")
OUTPUT_DIR = os.path.join(BASE_DIR, "models", "text_baseline")
# =======
